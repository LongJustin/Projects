var s_bird, s_bg, s_fg, s_pipeNorth, s_pipeSouth, s_text, s_score, s_splash, s_buttons, s_medals, s_numberS, s_numberB;
...
function initSprites(img) {
	...
	s_buttons = {
		...
		Pause: new Sprite(img, 199, 177, 13, 13),
		Play: new Sprite(img, 199, 191, 13, 13) 
	}
	s_medals = {
		Bronze: new Sprite(img, 198, 137, 22, 22),
		Silver: new Sprite(img, 198, 113, 22, 22),
		Gold: new Sprite(img, 174, 137, 22, 22),
		Platinum: new Sprite(img, 174, 113, 22,22)
	}
